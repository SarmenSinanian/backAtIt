...
class Solution:
    ...
    def checkValid(self, matrix):
        ...
        for i in range(len(matrix)):
            for j in range(len(matrix[0])):
                if self.isRowValid(i, j, matrix):
                    return False
                if self.isColumnValid(i, j, matrix):
                    return False

    def isRowValid(self, i, j, matrix):
        for i in range(len(matrix)):
            rowSet = set([])
            for j in range(len(matrix[0])):
                rowSet.add(matrix[i][j])
    ...
    def isColumnValid(self, i, j, matrix):
        for j in range(len(matrix[0])):
            colSet = set([])
            for r in range(len(matrix)):
                colSet.add(matrix[r][j])
...
# matrix = [[1,2,3,4,5,6],[2,1,3,4,5,6],[3,2,1,4,5,6]]
#
